...
# Vendor Tree
rm -rf vendor/nokia
git clone --depth=1 -b uno https://github.com/ProjectElixir-Devices/vendor_nokia_DRG vendor/nokia/DRG

# Common Vendor Tree
git clone --depth=1 -b uno https://github.com/ProjectElixir-Devices/vendor_nokia_sdm660-common vendor/nokia/sdm660-common
